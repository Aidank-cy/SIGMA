...
### [Maintenance] Sub-feature: Market index value/chart synchronization
- Status: COMPLETE
- Files modified: sigma-backend/app/services/market_indices.py, sigma-backend/tests/test_market_indices.py, CHANGELOG.md, .harness/progress.md
- Tests: PASS
...
### [Maintenance] Sub-feature: Post-close delayed Yahoo refetch
- Status: COMPLETE
- Files modified: sigma-backend/app/services/market_candles.py, sigma-backend/tests/test_market_indices.py, CHANGELOG.md, .harness/progress.md
...
### [Maintenance] Sub-feature: Sync collection log friendly errors
- Status: COMPLETE
- Files modified: sigma-frontend/src/app/[locale]/(main)/sync/page.tsx, CHANGELOG.md, .harness/progress.md
