...
def upgrade() -> None:
    ...
    category = sa.Enum("politics", "finance", "technology", "macro", "other", name="intelligence_category")
    ...
    op.create_index("ix_collected_items_source_id_collected_at", "collected_items", ["source_id", "collected_at"])
    ...
    op.create_index("ix_collector_logs_source_id_executed_at", "collector_logs", ["source_id", "executed_at"])
