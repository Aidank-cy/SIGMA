...
async def get_sentiment_stats(db: AsyncSession, days: int = 0) -> SentimentStatsResponse:
...
async def get_trending_keywords(db: AsyncSession, days: int = 1) -> TrendingKeywordsResponse:
...
async def get_last_collection(db: AsyncSession) -> LastCollectionResponse:
